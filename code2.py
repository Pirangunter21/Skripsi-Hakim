...
ram_usage.append((ram - start_ram) / detection_time)
...
csv_writer.writerow(['FPS', 'Detection Time', 'Detection Speed', 'RAM Usage'])
for i in range(len(fps_values)):
    csv_writer.writerow([fps_values[i], detection_times[i], detection_speeds[i], ram_usage[i]])
output_file.close()
